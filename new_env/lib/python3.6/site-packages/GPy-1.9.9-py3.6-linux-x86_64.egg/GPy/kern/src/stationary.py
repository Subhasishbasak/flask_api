...
from paramz.transformations import Logexp, Exponent, IdentityPosReals, ReciprocalSquare
...
class Stationary(Kern):
    ...
    def __init__(self, input_dim, variance, lengthscale, ARD, active_dims, name, param, useGPU=False):
        ...
        if param == 'softplus' :
        	...
        	self.lengthscale = Param('lengthscale', lengthscale, Exponent())
        	self.variance = Param('variance', variance, Exponent())
        elif param == 'naive' :
            self.lengthscale = Param('lengthscale', lengthscale, IdentityPosReals())
            self.variance = Param('variance', variance, IdentityPosReals())
        elif param == 'rp_square' :
        	self.lengthscale = Param('lengthscale', lengthscale, ReciprocalSquare())
        	self.variance = Param('variance', variance, ReciprocalSquare())
...
class Matern52(Stationary):
    ...
    """
    def __init__(self, input_dim, variance=1., lengthscale=None, ARD=False, active_dims=None, name='Mat52', param = 'softplus'):
        super(Matern52, self).__init__(input_dim, variance, lengthscale, ARD, active_dims, name, param)
